"""
src/voxflow/utils/config.py

Configuration management for the Voxflow application.

All user preferences and secrets are stored in a ``.env`` file at the project
root.  :class:`ConfigManager` provides a thin, thread-safe façade over
