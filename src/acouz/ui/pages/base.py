...
src/acouz/ui/pages/base.py

Abstract base class for all AcouZ application pages.
"""
...
class BasePage(QScrollArea):
    """Abstract base class for every page widget in :class:`~acouz.ui.app.AcouZApp`.
    ...
    user toggles the DARK/LIGHT theme, :meth:`~acouz.ui.app.AcouZApp.apply_theme`
    ...
    def retheme(self, t: Theme) -> None:
        ...
        Args:
            t: The new :class:`~acouz.ui.styles.Theme` instance to apply.
        """
        ...
    ...
    def retranslate(self) -> None:
        ...
        Implementors must call :func:`~acouz.utils.i18n.tr` for every
        ...
        :meth:`~acouz.ui.app.AcouZApp.retranslate_all` whenever the user
