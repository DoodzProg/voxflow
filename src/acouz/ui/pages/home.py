...
src/acouz/ui/pages/home.py

Dashboard / home page for the AcouZ application.
...
rebuilt dynamically via :meth:`~acouz.ui.app.AcouZApp.refresh_home_shortcuts`.
"""
...
class HomePage(BasePage):
    ...
    :class:`~acouz.ui.app.AcouZApp` writes to directly:

    Attributes:
        stat_words:        :class:`~acouz.ui.components.StatCard` for word count.
        stat_time:         :class:`~acouz.ui.components.StatCard` for recording time.
        stat_wpm:          :class:`~acouz.ui.components.StatCard` for WPM.
        stat_sessions:     :class:`~acouz.ui.components.StatCard` for session count.
    ...
    def retheme(self, t: Theme) -> None:
        ...
        # History items are fully rebuilt by AcouZApp.refresh_dashboard()
